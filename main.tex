...
\title{27 Lines}
\date{First Edition}
\author[Cubic surfaces]{Cubic surfaces}
\publisher{Del Pezzo surfaces}
...
\newtheorem{thm-def}{Theorem-Definition}
...
It is a celebrated fact that there are $27$ lines over a smooth cubic surface in $\mathbb{P}^3(\mathbb{C})$. In this note, we try to explore this fact with wider generality and deeper interpretation.
...
% This part is dedicated to collect necessary prerequisites in algebra and geometry. The reader should not pay too much attention to this part as it is not the most interesting part.

\chapter{Field theory}

\input{text/Part I/1. Field Theory/chapter.tex}

\chapter{Geometry}

\input{text/Part I/2. Geometry/chapter.tex}
